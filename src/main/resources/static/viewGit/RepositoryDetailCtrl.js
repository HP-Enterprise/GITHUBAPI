define(['../scripts/git','jquery'],function(module,$){
    module.controller("RepositoryDetailCtrl",function($scope,$http,$routeParams){
        ...
        var url1="/api/repositoryBranch/"+$scope.repository+"/"+loginCookie;
        ...
        var url2="/api/contributorList/"+$scope.repository+"/"+loginCookie;
        ...
        var url3="/api/repositoryCommit/"+$scope.repository+"/"+loginCookie;
