define(['../scripts/git', 'jquery'], function (module, $) {
    module.controller("yearCtrl", function ($scope, $http) {
        ...
        $scope.getAllGitHubWork = function (flag) {
            ...
            $scope.workSearch = {
                params: {
                    ...
                    year:$scope.worKeSelect.weekNum,
        ...
        $scope.DownloadExcel = function (flag) {
            ...
            $scope.url = "http://localhost:8080/api/exportYearExcel?" + $scope.REALNAME + "&" + $scope.USERNAME + "&" + $scope.WEEKNUM;
